...
class OptionTest {
    ...
    fun `throws for invalid quantity`(quantity:Int) {
        ...
        }.message).isEqualTo("quantity must be positive and less than 100000000.")
    }
    ...
    fun `throws for invalid price`(price:Double) {
        ...
        }.message).isEqualTo("price must be greater than 0.01")
    }
    ...
    fun `throws for empty name`(name: String) {
        ...
        }.message).isEqualTo("name must not be empty")
    }
    ...
    fun `throws for long name`() {
        ...
        }.message).isEqualTo("name must be less than 50 characters")
    }
    ...
    fun `throws for invalid character name`(name: String) {
        ...
        }.message).isEqualTo("name must match pattern")
    }
    ...
    fun `throws for invalid imageUrl`(imageUrl: String) {
        ...
        }.message).isEqualTo("image URL must valid url")
    }
